...
// Credit Endpoints
router.put('/addcredit', rewardifyController.addCredit)

// Replaces Credit with new amount
router.put('/replacecredit', rewardifyController.replaceCredit)

// Subtracts from amount
router.put('/subtractcredit', rewardifyController.subtractCredit)
